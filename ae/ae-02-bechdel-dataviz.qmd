...
-   The `geom_xx` function specifies the type of plot we want to use to represent the data. In the code below, we use `geom_bar()` which creates a bar plot where the height of each bar shows the number of movies in each category.
