...
a.  Fit another logistic regression model predicting `spam` from `dollar` and other variable(s) you think would be a good predictor.
...
e.  Based on the false positive and false negatives rates of this model, comment, in 1-2 sentences, on which model (one from Question 19 or Question 20) is preferable and why.
