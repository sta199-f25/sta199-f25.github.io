...
Add these values to the data frame `df` and display the updated data frame.
...
Extract the model coefficients and the R-squared value from the model summary.
