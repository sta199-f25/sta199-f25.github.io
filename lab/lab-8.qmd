...
```{r}
rdu_flights_sample <- read_csv("lab/data/rdu-flights-sample.csv")
```
...
::: callout-note
If your p-value is less than or equal to $\alpha$, you reject the null hypothesis.
If your p-value is greater than $\alpha$, you fail to reject the null hypothesis.
