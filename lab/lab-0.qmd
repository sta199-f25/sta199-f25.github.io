...
Go to your RStudio container and log in if you haven't already: <https://cmgr.oit.duke.edu/containers>.
...
-   Since this is the first time you are connecting to GitHub from this RStudio instance, you will be asked to confirm the authenticity of the host.
    ...
    ![](images/lab-0/authenticity-of-host.png){fig-alt="Authenticity of host pop-up window asking to confirm the authenticity of the host. Type 'yes' in the box and hit Enter."}
...
**TO DO: Update link above once quiz is live.**
