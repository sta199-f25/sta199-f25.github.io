...
a.  What type of plot would be appropriate to visualize the relationship between `age` and `opinion` on legalizing medical marijuana in North Carolina based on this survey's results?

b.  Create the plot, using `geom_col()`, from part (a) that can be used to evaluate the relationship between `age` and `opinion` on legalizing medical marijuana in North Carolina based on this survey's results.

::: callout-tip
Your visualization should display the proportions you calculated in Question 1(d).
:::

c.  Based on your calculations so far, as well as your visualization, write 1-2 sentences that describe the relationship, in this sample, between age and opinion on legalizing medical marijuana in North Carolina.
