...
|:---------|:------------------------------------------------|
| Age      | 18-44; 45+                                      |
| Opinion  | Very positive; Somewhat positive; Neither positive nor
negative; Somewhat negative; Very negative; Unsure |
...
- 162 individuals said they thought the changes were Neither positive nor negative,
...
- 186 individuals said they thought the changes were Neither positive nor negative,
...
::: callout-tip
You will need to repeat certain values in the `age` and `opinion` columns to fill in all the counts.
You can use the `rep()` function to help you do this, e.g., if you had 3 individuals in the "18-44" age group and 4 individuals in the "45+" age group, you could use:
...
c.  Marginal proportions of opinion: Calculate the proportions of individuals who are Very positive, Somewhat positive, Neither positive nor negative, Somewhat negative, Very negative, and Unsure.

d.  Conditional proportions of opinion based on age: Calculate the proportions of individuals who are Very positive, Somewhat positive, Neither positive nor negative, Somewhat negative, Very negative, and Unsure
...
b.  Create the plot, using `geom_col()`, from part (a) that can be used to evaluate the relationship between age and `opinion` on the impact of the many changes taking place in Division I college athletics?

::: callout-tip
Your visualization should be displaying the proportions you calculated in Question 1(d).
:::

c.  Based on your calculations so far, as well as your visualization, write 1-2 sentences that describe the relationship, in this sample, between age and opinion on the impact of the many changes taking place in Division I college athletics?
