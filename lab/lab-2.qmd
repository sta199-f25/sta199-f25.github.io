...
The `tibble()` function creates the data frame (the `tibble` object) `df_1` with two variables: `team` and `score`.
...
For the two questions in this lab, you will work with the following dataset called `df_2`.
This code is already included in your lab document.
