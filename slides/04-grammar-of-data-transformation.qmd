...
-   Following along with code along videos: See https://sta199-f25.github.io/computing-code-alongs.html -- Clone the `code-alongs` repository and work throgh the relevant `.qmd` files as you watch the videos. Use the project navigator in RStudio to switch between your `code-alongs` project and your other projects (ae, labs, HWs, etc.).
