...
Go to the [course GitHub organization](https://github.com/sta199-f24) and clone `ae-YOUR-GITHUB-NAME` repo to [your container](https://cmgr.oit.duke.edu/containers).
...
![](images/02/tour-git-github-1.png){fig-align="center" width="1000"}
...
![](images/02/tour-git-github-2.mov){fig-align="center" width="600"}
...
Feel free to grab one before you leave!
