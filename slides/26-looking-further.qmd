...
obs_diff <- sex_discrimination |>
  ...
  calculate("diff in props", success = "promoted", order = c("male", "female"))
...
::: question
What is the probability of getting an outcome $$ 4 when rolling a 6-sided die? What is the probability when rolling a 12-sided die?
:::
...
::: question
You're playing a game where you win if the die roll is $$ 4. If you could get your pick, which die would you prefer to play this game with?
:::
...
- We want to find P(A is good $|$ outcome of $1^{st}$ roll).

- This is a conditional probability so we'll use Bayes' Theorem
...
- Earlier, we decided that the prior probability, P(A good) = 0.5.
