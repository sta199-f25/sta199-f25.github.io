...
- Logistic regression with a numerical predictor [✅]{.fragment}
...
- `augment()` returns the data frame passed to `new_data` _augment_ed by
  ...
  - the predicted probability of failure, and
...
::: wooclap-choices
- True positive rate
- Area under the ROC curve [✅]{.fragment}
- Adjusted R-squared
...
::: wooclap-choices
- on average, holding hotel type constant. [✅]{.fragment}
...
- Resort Hotels bookings are predicted to have an average daily rate that is \$10.70 lower than City Hotels, on average, holding number of adults constant. [✅]{.fragment}
...
- The predicted average daily rate for a bookings with 0 adults at a City Hotel is \$50.50, on average. [✅]{.fragment}
