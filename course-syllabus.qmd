...
Labs are generally due at 11:59 pm ET on the indicated due date (generally the Sunday following the lab).
...
-   **Use of generative artificial intelligence (AI)**: You should treat generative AI, such as ChatGPT, like other online resources. Two guiding principles govern how to use AI in this course:
    ...
    -   {{< fa ban title="Ban">}} **AI tools for narrative:** Unless instructed otherwise, you may not use generative AI to generate a narrative that you then copy-paste verbatim into an assignment or edit and then insert into your assignment.
...
If you've read this far in the syllabus, post a picture of your pet if you have one or your favorite meme on ed in [this thread](https://edstem.org/us/courses/80616/discussion/5172863)! If you're willing, share the name of your pet too!
:::
