...
In a single pipeline, identify the outliers in the plot in Question 7, and return a data frame with the county name, county type, percentage with higher education, and percentage of children living in poverty.
