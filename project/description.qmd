...
You should employ methods we learned in the first half of the course, up til and including Week 8 (i.i.e., excluding modeling and inference).
...
6.  Milestone 6 - Presentation with slides and a reproducible project write-up of your analysis, with a draft along the way
...
Instructions and grading criteria for this milestone are outlined in [Milestone 5: Improvement + progress II: project to polish](/project/3-improvement-progress-II.html).

# Milestone 6 - Write-up and presentation

Instructions and grading criteria for this milestone are outlined in [Milestone 6: Write-up + presentation](/project/6-writeup-presentation.html).
...
| **M6: Reproducibility + organization** | 5 pts   |
| **Teamwork**                       | 10 pts  |
